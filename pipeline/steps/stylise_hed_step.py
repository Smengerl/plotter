...
class _HEDStylizer(NNBaseStylizer):
    """Holistically-nested Edge Detection (Xie & Tu 2015)."""
...
class StyliseHEDStep(PipelineStep):
    """
    ...
    def process(self, ctx: ImageContext) -> ImageContext:
        ...
        logger.debug("StyliseHEDStep: Binary image %dx%d px", binary.shape[1], binary.shape[0])
